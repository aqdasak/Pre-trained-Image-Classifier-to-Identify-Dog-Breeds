...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print('\nCNN model architecture used=',model)
    ...
    print(f"% Correct Not Dog= {results_stats_dic['pct_correct_notdogs']:.2f}%")
    print(f"% Labels matched= {results_stats_dic['pct_match']:.2f}%")

    if print_incorrect_dogs and results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
        print('\nFollowing are misclassified as dogs:')
